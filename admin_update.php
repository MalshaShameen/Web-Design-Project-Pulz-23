...
<div class="admin-product-form-container centered">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="Update product" name="update_product" class=" btn btn-outline-primary btn-lg">
      <a href="dashbord.php" class="btn btn-outline-primary btn-lg">Go back!</a>
   </form>
