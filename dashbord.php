...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      if($upload){
        ...
        echo "<script> alert('There was an error adding the product');</script>";
      }
   }
...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4">
                    ...
                    if(isset($_SESSION['user'])){
                        ...
                        echo ("<a href='dashbord.php' class='nav-item nav-link active'> Dashbord</a>");
                     }
                     else{
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Dashbord</h1>
            <div class="d-inline-flex mb-lg-5">
                <p class="m-0 text-white"><a class="text-white" href="index.html"
                        style="text-decoration: none;">Home</a></p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">Dashbord</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
...
<!-- Edit Products Start -->
   ...
   <h4 class="table-caption mb-4 mt-3">
                Edit Or Delete a existing Product
    </h4>
      <table class="table table-hover table-responsive-lg table-responsive-md table-responsive-sm">
         ...
         <tr>
            ...
            <td>
               <a href="admin_update.php?edit=<?php echo $row['id']; ?>" class="btn btn-light"> <i class="fas fa-edit"></i> Edit </a>
               <a href="dashbord.php?delete=<?php echo $row['id']; ?>" class="btn btn-light"> <i class="fas fa-trash"></i> Delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
...
<!-- Add new Products Start -->
<div class="container">
    <div class="row">
        <div class="col-12 card card-body bg-light">
        
        <div class="container d-flex align-items-center justify-content-center" style="background-color:transparent;">
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         <h3 class="">Add a new product</h3>
         <div class="form-group">
            <label for="product_name" class="text-primary form-control-lg">Product Name</label> <br>
            <input type="text" placeholder="Enter product name" name="product_name"  class="form-control">
         </div>
         
         <div class="form-group">
            <label for="product_price" class="text-primary form-control-lg">Price - </label> <br>
            <input type="number" placeholder="Enter product price" name="product_price" class="form-control form-control">
         </div>
         <div class="form-group">
            <label for="product_image" class="text-primary form-control-lg">Upload Image</label> <br>
            <input type="file" accept="image/png, image/jpeg, image/jpg" name="product_image" class="form-control-file ">
        </div>
         <input type="submit" class="btn btn-light btn-outline-primary" name="add_product" value="Add product" class="form-control">
      </form>
